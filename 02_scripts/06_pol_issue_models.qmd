---
title: "Analysis of Motivated Reasoning on Political Topics Using Issue Motives"
format:
  html:
    theme:
      light: lux
...
model_dir <- here("03_output", "models", "pol_issue")
dia_dir <- here("03_output", "diagnostics", "pol_issue")
