---
title: "Figures and tables based on ideo motive analyses (secondary)"
format:
  html:
    theme: lux
    toc: true
...
pol_model_dir <- here("03_output", "models", "pol_ideo")
nonpol_model_dir <- here("03_output", "models", "nonpol_ideo")

table_dir <- here("03_output", "tables", "combined_ideo")
fig_dir <- here("03_output", "figures", "combined_ideo")
